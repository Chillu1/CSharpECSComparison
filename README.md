...
| Components Type support                    | struct                | struct                | struct<br/>/class<br/>/interface | struct?            | struct                          | class                       | struct                     | class                           | class               | class?              | Components Type support                    |
...
| Reactive System                            | :x:                   | :x:                   | :heavy_check_mark:               |                    | :x:?                            | :heavy_check_mark:          |                            | :heavy_check_mark:              |                     | :heavy_check_mark:  | Reactive System                            |
...
| Unity Burst Compatible                     | :x:                   | :heavy_check_mark:Ex  | :x:                              | :heavy_check_mark: | :x:                             | :x:                         | :heavy_check_mark:         | :x:?                            | :x:?                | :x:                 | Unity Burst Compatible                     |
| Unity Jobs Compatible                      | :x:                   | :heavy_check_mark:Ex  | :x:                              | :heavy_check_mark: | :x:                             | :x:                         | :heavy_check_mark:         | :x:?                            | :x:?                | :heavy_minus_sign:? | Unity Jobs Compatible                      |
